...
![Задание 9](image/9.png){#fig:010 width=70%}
...
![Задание 19](image/19.png){#fig:021 width=70%}
...
![Задание 22](image/22.png){#fig:024 width=70%}

-q
--quiet
    Turn off Wget's output. 

![Задание 23](image/23.png){#fig:025 width=70%}
...
![Задание 24](image/24.png){#fig:026 width=70%}

![Задание 25](image/25.png){#fig:027 width=70%}

gzip (сокращение от GNU Zip) — утилита сжатия и восстановления (декомпрессии) файлов, использующая алгоритм Deflate.

![Задание 26](image/26.png){#fig:028 width=70%}
...
![Задание 27](image/27.png){#fig:029 width=70%}
...
![Задание 28](image/28.png){#fig:030 width=70%}

Регистр - маленькая буква, слово - `world`, а не `word`

![Задание 29](image/29.png){#fig:031 width=70%}
